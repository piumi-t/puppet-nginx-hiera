class nginx::config(
  ...
  $config_vdir_enable_debian   = $::nginx::config_vdir_enable_debian,
  $config_vdir_enable_default  = $::nginx::config_vdir_enable_default,
  $config_process_user_debian  = $::nginx::config_process_user_debian,
  $config_process_user_default = $::nginx::config_process_user_default,
  $vhost_dir_debian            = $::nginx::vhost_dir_debian,
